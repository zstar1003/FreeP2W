...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default="weights/doclayout_yolo_docstructbench_imgsz1024.pt", required=False, type=str)
    parser.add_argument('--image-path', default="test_files/test_img.png", required=False, type=str)
